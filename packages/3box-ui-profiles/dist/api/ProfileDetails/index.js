...
var ProfileDetails = function ProfileDetails(_ref) {
  ...
  return _react["default"].createElement(Atom.Flex, (0, _extends2["default"])({
    ...
    lg: true,
    heavy: true
  }, props.styledName.first), _uiCompose.validate.isStringRender(box.profile.id.name.first)), _react["default"].createElement(Atom.Heading, (0, _extends2["default"])({
    md: true,
    thin: true,
    ml: 2
    ...
    fontSize: [2]
  }, props.styledJob), _react["default"].createElement(Atom.Span, props.styledJob, _uiCompose.validate.isStringRender(box.profile.id.occupation.job)), (0, _idx["default"])(box, function (_) {
    return _.profile.id.occupation.employer;
  }) && _react["default"].createElement(Atom.Span, props.styledEmployer, "at ", _uiCompose.validate.isStringRender(box.profile.id.occupation.employer))));
};
