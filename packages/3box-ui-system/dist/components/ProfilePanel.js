...
var BoxLoginAvatar = (_ref) => {
  ...
  return _react.default.createElement(Atom.Box, null, _react.default.createElement(_BoxLoginCard.default, null));
};
...
BoxLoginAvatar.defaultProps = {
  ...
  employer: 'ConsenSys',
  panelContent: _react.default.createElement(Atom.Card, {
    content: "winning"
  })
};
