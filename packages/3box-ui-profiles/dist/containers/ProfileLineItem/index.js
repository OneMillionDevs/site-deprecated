...
var ProfileLineItem = function ProfileLineItem(_ref) {
  ...
  return !profile ? null : _react["default"].createElement(Atom.Flex, (0, _extends2["default"])({
    alignCenter: true,
    between: true
  }, props.styled), _react["default"].createElement(Atom.Flex, {
    alignCenter: true
    ...
    alignCenter: true
  }, _react["default"].createElement(Atom.Heading, props.styledName.first, _uiCompose.validate.isStringRender(profile.id.name.first)), props.displayNameLast && _react["default"].createElement(Atom.Heading, (0, _extends2["default"])({
    md: true,
    thin: true,
    ml: 2
  }, props.styledName.last), _uiCompose.validate.isStringRender(profile.id.name.middle), " ", _uiCompose.validate.isStringRender(profile.id.name.last)))), _react["default"].createElement(Atom.Box, null, _react["default"].createElement(Atom.Link, {
