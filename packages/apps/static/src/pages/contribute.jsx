    ...
    <Atom.Box gradient='gray'>
      ...
      <Atom.Container maxWidth={980}>
        <Atom.Flex alignCenter card between mt={-50} p={4} mt={-50}>
          <Atom.Box>
            ...
            <Atom.Paragraph xs mb={0}>Share your project with the community. Help guide new developers.</Atom.Paragraph>
          </Atom.Box>
      ...
      <Atom.Container my={5}>
        <A.Flex flex={1}>
          ...
          <Atom.Flex center column flex={2}>
            <Atom.Image circle card src='https://images.ui8.net/uploads/exchange_cryptocurrency_2_1526963073323.jpg'/>
          </Atom.Flex>
        </A.Flex>
      </Atom.Container>
      ...
      <Atom.Container maxWidth={680} my={5}>
        <Atom.Flex column card between my={4}>
            ...
            <Atom.Heading sm heavy>Tap into What's Possible</Atom.Heading>
            <Atom.Paragraph sm>
              Praesent ut cursus neque. Proin viverra luctus velit nec pharetra. Praesent at dui non justo egestas laoreet. Quisque et euismod augue. Phasellus luctus, libero et malesuada mollis, mi libero pretium nibh, in varius orci enim quis purus. Pellentesque tincidunt eros quis est ultricies, et efficitur mauris tempor. Donec mollis rhoncus tortor sit amet finibus.
            </Atom.Paragraph>
            <Atom.Heading sm heavy>The Growing Etheruem Community</Atom.Heading>
            <Atom.Paragraph sm>
              Praesent ut cursus neque. Proin viverra luctus velit nec pharetra. Praesent at dui non justo egestas laoreet. Quisque et euismod augue. Phasellus luctus, libero et malesuada mollis, mi libero pretium nibh, in varius orci enim quis purus. Pellentesque tincidunt eros quis est ultricies, et efficitur mauris tempor. Donec mollis rhoncus tortor sit amet finibus.
            </Atom.Paragraph>
        </Atom.Flex>
        ...
        <Atom.Container maxWidth={980} py={4}>
          <Atom.Flex alignCenter card betweenp={5}>
           <Atom.Box pr={5}>
              ...
              <cite>Kames Geraghty - FullStack Javascript Developer @ ConsenSys</cite>
           </Atom.Box>
          <Atom.Image circle card p={1} maxWidth={200} src='https://imgur.com/AQJxQdX.png'/>
          </Atom.Flex>
        </Atom.Container>
