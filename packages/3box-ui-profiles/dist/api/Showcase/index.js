...
var Showcase = function Showcase(_ref) {
  ...
  return _react["default"].createElement(Atom.Box, props.styled, _react["default"].createElement(_boxUiProfilesStateless.ProfileCover, {
    image: box.profile.coverPhoto,
    styled: props.styledCover
  }), _react["default"].createElement(Atom.Absolute, {
    left: 0,
    right: 0,
    top: 0,
    m: 3
    ...
    between: true,
    flex: 1
  }, _react["default"].createElement(Atom.Panel, null, _react["default"].createElement(Atom.Span, {
    xxs: true,
    tag: "white"
  }, "keys")), _react["default"].createElement(Atom.Span, null, _react["default"].createElement(_Verifications["default"], null)))), _react["default"].createElement(Atom.Absolute, {
    left: 0,
    right: 0,
    bottom: 0,
    m: 3
    ...
    between: true,
    flex: 1
  }, _react["default"].createElement(_ProfilePreview["default"], null), _react["default"].createElement(Atom.Panel, null, _react["default"].createElement(Atom.Span, {
    xs: true,
    tag: "primary"
  }, "Menu")))));
};
