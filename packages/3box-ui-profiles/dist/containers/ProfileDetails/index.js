...
var ProfileCard = function ProfileCard(_ref) {
  ...
  return !profile ? null : _react["default"].createElement(Atom.Box, props.styled, profile.biography && _react["default"].createElement(Atom.Markdown, null, profile.biography));
};
