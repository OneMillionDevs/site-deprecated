...
var ProfileCard = function ProfileCard(_ref) {
  ...
  return !profile ? null : _react["default"].createElement(Atom.Box, props.styled, _react["default"].createElement(Atom.Flex, {
    bg: "blue",
    minHeight: 140,
    flex: 1,
    width: "100%"
    ...
    styled: props.styledCover
  })), _react["default"].createElement(Atom.Flex, (0, _extends2["default"])({
    center: true,
    column: true
  }, props.styledMain), _react["default"].createElement(Atom.Box, {
    style: {
    ...
    alignCenter: true
  }, _react["default"].createElement(Atom.Heading, (0, _extends2["default"])({
    lg: true,
    heavy: true
  }, props.styledName.first), _uiCompose.validate.isStringRender(profile.id.name.first)), props.displayNameLast && _react["default"].createElement(Atom.Heading, (0, _extends2["default"])({
    md: true,
    thin: true,
    ml: 2
  ...
  }) && _react["default"].createElement(Atom.Span, (0, _extends2["default"])({
    fontSize: [2]
  }, props.styledJob), _react["default"].createElement(Atom.Span, props.styledJob, _uiCompose.validate.isStringRender(profile.id.occupation.job)), props.displayEmployer && (0, _idx["default"])(profile, function (_) {
    return _.id.occupation.employer;
  }) && _react["default"].createElement(Atom.Span, props.styledEmployer, "at ", _uiCompose.validate.isStringRender(profile.id.occupation.employer)))), isFooterActive && _react["default"].createElement(Atom.Flex, props.styledFooter));
};
