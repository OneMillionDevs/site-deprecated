import {CardLarge, DeveloperOpportunityItem} from '@components/experiments';
    ...
    <Atom.Flex flex={1} sx={styles.showcase.container}>
      ...
      <Atom.Flex center column sx={{flex: 1}}>
        ...
        <Atom.Heading giga heavy sx={{mt: 0}}>
          <Atom.Span heavy>Ethereum Analytics</Atom.Span>
        </Atom.Heading>
        <Atom.Paragraph>
          Tracking the technical growth and community evolution of Ethereum.
        </Atom.Paragraph>
        {/* <Atom.Flex between sx={styles.opportunityList}>
          <DeveloperOpportunityItem
            title="Blockchain"
            subtitle="Tracking Important Key Metrics"
            image="https://image.flaticon.com/icons/svg/1574/1574033.svg"
            to="/build"
          />
          <DeveloperOpportunityItem
            title="Developers"
            subtitle="Analysis of Developer Engagement"
            image="https://image.flaticon.com/icons/svg/1574/1574033.svg"
            to="/build"
          />
          <DeveloperOpportunityItem
            title="Holistic"
            subtitle="A complete perspective."
            image="https://image.flaticon.com/icons/svg/1574/1574033.svg"
            to="/build"
          />
        </Atom.Flex> */}
    ...
    <Atom.Flex
      ...
      <Atom.Flex center column sx={styles.reportCategory}>
        ...
        <Atom.Flex center column sx={{flex: 1}}>
          {/* <GraphAxis width={500} height={500} margin={20} /> */}
          <Atom.Heading giga heavy sx={{mt: 0}}>
            <Atom.Span heavy>Blockchain</Atom.Span>
          </Atom.Heading>
          <Atom.Heading sm>Transactions - Contracts - Engagement</Atom.Heading>
          <Atom.Button>Register for Report</Atom.Button>
        </Atom.Flex>
      </Atom.Flex>
      ...
      <Atom.Flex center column sx={styles.reportCategory}>
        ...
        <Atom.Flex center column sx={{flex: 1}}>
          {/* <GraphAxis width={500} height={500} margin={20} /> */}
          <Atom.Heading giga heavy sx={{mt: 0}}>
            <Atom.Span heavy>Developers</Atom.Span>
          </Atom.Heading>
          <Atom.Heading sm>Jobs - Contributions - Meetups</Atom.Heading>
          <Atom.Button>Register for Report</Atom.Button>
        </Atom.Flex>
      </Atom.Flex>
    </Atom.Flex>
