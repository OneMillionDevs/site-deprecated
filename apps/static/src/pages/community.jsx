      ...
      <Atom.Container my={5}>
        <A.Flex flex={1}>
          ...
          <Atom.Flex center column flex={2}>
            <Atom.Image p={1} card src='https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80'/>
          </Atom.Flex>
        </A.Flex>
      </Atom.Container>
        ...
        <A.Flex flex={1}>
          <A.Flex center column flex={3} order={2}>
            <A.Box px={100}>
              ...
              <A.Paragraph>
                Help others stay up-to-date with what's happening in the ecosystem. Write about new projects, major releases happening with existing codebases, guides to try new tools, etc....
              </A.Paragraph>
          ...
          <Atom.Flex center column flex={2} order={1}>
            <Atom.Image p={1} card src='https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1652&q=80'/>
          </Atom.Flex>
        </A.Flex>
      </Atom.Container>
        ...
        <A.Flex flex={1}>
          <A.Flex center column flex={3}>
            <A.Box px={100}>
              ...
              <A.Heading lg thin>Publish Code for the Community</A.Heading>
              <A.Paragraph>
                Pellentesque luctus tempus enim et convallis. Sed mattis justo vitae enim semper, tempor auctor ante convallis. Fusce maximus et risus id condimentum. Donec iaculis massa at nisl feugiat, sed ornare magna vehicula. Cras tincidunt mauris ipsum, ac aliquet nulla fermentum quis.
              </A.Paragraph>
              <A.Modal content={<ReferAFriend/>} >
          ...
          <Atom.Flex center column flex={2}>
            <Atom.Image p={1} card src='https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80'/>
          </Atom.Flex>
        </A.Flex>
      </Atom.Container>
