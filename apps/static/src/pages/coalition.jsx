...
export default props => (
  <Site>
    <A.Box>
      <A.Box fullWidth color="white" gradient="blueOcean" py={6} textCenter>
        ...
        <A.Heading giga heavy>
          Etereum Developers Coalition
        </A.Heading>
        <A.Heading lg>
          Contribute to the Positive Growth of Ethereum
        </A.Heading>
      </A.Box>
    </A.Box>
    ...
    <Atom.Container maxWidth={780} mt={5}>
      ...
      <Atom.Heading lg heavy>What is The Coalition</Atom.Heading>
      <Atom.Paragraph >
        The One Million Ethereum Developers coalition is a network of teams and organizations committed to helping grow the Ethereum ecosystem.
      </Atom.Paragraph>
      <Atom.Heading md heavy>Objectives</Atom.Heading>
      <ul>
        <li>
          Substainly grow the number of Ethereum developers.
        </li>
        <li>
          Teach new developers about powerful features of Ethereum.
        </li>
        <li>
          Facilitate peer-to-peer connections for accelerated learning.
        </li>
    ...
    <Atom.Box>
      <Atom.Container my={4} maxWidth={1080}>
        <Atom.Heading xxl heavy center mt={6}>Active Coalition Members</Atom.Heading>
