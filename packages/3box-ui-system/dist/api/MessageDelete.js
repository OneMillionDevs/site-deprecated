...
var MessageDelete = (_ref) => {
  ...
  return props.children ? _react.default.createElement(Atom.Span, {
    ...
    onClick: deleteRequestHandler
  }, props.componentIsThreadJoined)) : isThreadyReady ? _react.default.createElement(Atom.Span, _extends({}, props.styledLablActive, {
    onClick: deleteRequestHandler
  }), props.componentIsThreadReady) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(Atom.Toast, {
    content: _react.default.createElement(DeleteAttemptMessage, null)
  }, _react.default.createElement(Atom.Flex, {
    alignCenter: true
  }, _react.default.createElement(Atom.Span, props.styledLablLoading, props.isLoadingComponent))));
};

var DeleteAttemptMessage = props => _react.default.createElement(Atom.Flex, {
  column: true
}, _react.default.createElement(Atom.Span, {
  xs: true,
  mb: 3
...
MessageDelete.defaultProps = {
  ...
  componentIsLoggedOut: _react.default.createElement(Atom.Span, {
    pointer: true,
    xxs: true,
    tag: "white",
    opacity: 1
  }, "Login ", _react.default.createElement(Atom.Span, {
    opacity: .6,
    pl: 1
  }, _react.default.createElement(Atom.LoadingSquare, null))),
  componentIsLoading: _react.default.createElement(Atom.Span, {
    pointer: true,
    xxs: true,
    tag: "white",
    opacity: 1
  }, "Loading ", _react.default.createElement(Atom.Span, {
    pl: 1
  }, _react.default.createElement(Atom.LoadingSquare, {
    className: "active"
  }))),
  componentIsLoggedIn: _react.default.createElement(Atom.Span, {
    pointer: true,
    xxs: true,
    tag: "white",
    opacity: 1
  }, "Opened ", _react.default.createElement(Atom.Span, {
    pl: 1
  }, _react.default.createElement(Atom.LoadingSquare, {
    className: "active"
  }))),
  componentIsSpaceOpen: _react.default.createElement(Atom.Span, {
    pointer: true,
    xxs: true,
    tag: "blue"
  }, "Space Opened"),
  componentIsThreadJoined: _react.default.createElement(Atom.Span, {
    pointer: true,
    xxs: true,
    tag: "red"
  }, "Remove from List"),
