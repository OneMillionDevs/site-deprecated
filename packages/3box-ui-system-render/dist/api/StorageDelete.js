...
var StorageDelete = (_ref) => {
  ...
  return props.children ? _react.default.createElement(Atom.Span, {
    ...
    onClick: deleteRequestHandler
  }, props.componentIsSpaceOpen)) : isSpaceReady ? _react.default.createElement(Atom.Span, _extends({}, props.styledLablActive, {
    onClick: deleteRequestHandler
  }), props.componentIsSpaceOpen) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(Atom.Toast, {
